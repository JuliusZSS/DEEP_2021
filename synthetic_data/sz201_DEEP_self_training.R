...
for (data_name in data_names) {
  ...
  for (n_batch in 1:10) {
    ...
    # import data
    DEEP_patterns_csv = paste(data_name,'/deep_self_training/deep_self_training_batch_',n_batch,'_patterns.csv',sep="")
    ...
    output_csv = write.csv(test_3, paste(data_name,'/deep_self_training/deep_self_training_batch_',n_batch,'_results.csv',sep = ""))
