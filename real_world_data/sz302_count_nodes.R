...
for (data_name in data_names) {
  ...
  for (n_cv in 1:10) {
    ...
    for (n_fold in 1:2) {
      ...
      file_1 = paste('data_',data_name,'/model_vs_contingency_table_',data_name,'_uplift/model_vs_contingency_table_cv_',n_cv,'_fold_',n_fold,'.csv', sep = "")
